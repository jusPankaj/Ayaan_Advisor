        ...
        {faqsData.map((faq, index) => (
          ...
          >
            <div className="flex items-center">
              <div className="px-3">
                <h1 className="text-[#3C3C4380]">{index > 9 ? {index} + 1: `0${index+1}`}</h1>
              </div>
              <div>
            ...
            <div>
              {isActive !== index ? (
                <div className="bg-[#F3F5F6] text-black rounded-full h-12 w-12 flex justify-center items-center text-[14px]">
                  +
                </div>
              ) : (
                <div className="bg-[#2C4058] text-white rounded-full h-12 w-12 flex justify-center items-center text-[14px]">
                  x
                </div>
              )}
            </div>
