...
//                           <img className="absolute w-[159px] h-[51px] top-px left-[93px]" alt="Logo" src="logo.png" />
...
//                         </div>
//                       </div>
//                       <img className="absolute w-2 h-[23px] top-[3px] left-[58px]" alt="Vector" src="vector-16.svg" />
//                     </div>
//                   </div>
//                 </div>
//                 <input
