  ...
  return (
    <div className="bg-[#2C4058] pt-24 md:px-[150px] xl:px-[206px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-7  ">
        ...
        <div className="col-span-3 pt-10 md:pt-0 order-2 md:order-4">
          <div className="flex flex-col justify-between">
            ...
            <form className="flex flex-col mb-6 md:mb-0 md:flex-row justify-center items-center mt-4 ">
              <input
                ...
                className="h-[58px] w-full p-3 border border-gray-400 rounded-md bg-[#FFFFFF1A] mb-4 md:mb-0 md:mr-4"
              />
              <button
                type="submit"
                className="h-[58px] px-6 bg-[#FED55F] rounded-md text-[#2C4058] text-[16px] font-bold outline-none"
              >
                Subscribe
              </button>
            </form>
