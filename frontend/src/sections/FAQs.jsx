...
const FAQs = () => {
  ...
  return (
    <div className='bg-[#FBFAFF]'>
        <div>
        <div className="w-[1029px] px-[250px]">
            <p className="text-slate-400">FAQs</p>
            <div>
                <h1 className="text-[#5981B2] font-semibold text-5xl">Frequently</h1>
                <h1 className="text-[#2C4058] font-semibold text-5xl">Asked Questions</h1>
            </div>
            <p className="text-[18px] my-4 text-[#2C4058CC] font-normal">Please find your answers.</p>
        </div>
        </div>
        <div className='min-h-screen bg-gray-50 flex items-center justify-center '>
            <AccordianFAQs faqsData = {faqsData}/>
        </div>
        <button className='bg-[#5981B2] text-white rounded-lg h-12 w-[155px] '>View All FAQs</button>
    </div>
  )
}
